        ...
        <div className="flex flex-wrap items-center justify-between mx-auto px-4 py-2">
          ...
          <div className="mobile-menu block md:hidden">
            {!navbarOpen ? (
              ...
              <button onClick={() => setNavbarOpen(false)} className="flex items-center px-3 py-2 border rounded border-slate-200 hover:text-white text-slate-200"><XMarkIcon className="h-5 w-5" /></button>
            )}
          </div>
